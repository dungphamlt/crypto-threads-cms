...
const AuthorCard: React.FC<AuthorCardProps> = ({ author, onView }) => {
  return (
    <div
      ...
      className="group bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:bg-gray-50 cursor-pointer hover:border-blue-500 w-full min-w-0"
    >
          ...
          <div className="flex items-center gap-3 mb-3 min-w-0">
            {author.avatarUrl ? (
              <Image
                ...
                width={100}
                height={100}
                className="w-14 h-14 rounded-full object-cover shadow-[0_0_4px_1px_rgba(0,0,0,0.2)] flex-shrink-0"
              />
            ) : (
